...
pip install einops==0.8.0 timm==1.0.14 wandb==0.19.1 lpips==0.1.4 torcheval-nightly==2024.7.31 scikit-image==0.25.2 calflops==0.3.2 transformers==4.49.0 seaborn==0.13.2 pandas==2.2.3
